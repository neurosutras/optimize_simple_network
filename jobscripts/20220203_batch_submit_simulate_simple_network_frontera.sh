#!/bin/bash -l
sh simulate_simple_network_frontera.sh config/simulate_simple_network_O_config.yaml \
...
sh simulate_simple_network_frontera.sh config/simulate_simple_network_P_config.yaml \
