#!/bin/bash -l
sh simulate_simple_network_replay_frontera.sh config/simulate_simple_network_replay_O_config.yaml \
...
sh simulate_simple_network_replay_frontera.sh config/simulate_simple_network_replay_P_config.yaml \
